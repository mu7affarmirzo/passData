...
# image = '/passportsrc/a38b652c4f1742ce958088ff4983a47a.jpg'
# path = os.path.dirname(__file__) + '/media_cdn_static/passportsrc')
path = os.path.dirname(__file__) + "/imgs"

# image = '/passportsrc/a38b652c4f1742ce958088ff4983a47a.jpg'
def pathpass(self, *args):
    global path
# path = os.path.dirname(__file__) + str(image))
